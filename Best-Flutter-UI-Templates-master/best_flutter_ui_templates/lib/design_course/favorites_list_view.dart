...
class FavoritesListView extends StatefulWidget {
  const FavoritesListView({Key? key, this.callBack}) : super(key: key);

  final Function(Person?)? callBack;
  @override
          ...
          builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemCount: Person.leaderboardList.length,
                scrollDirection: Axis.horizontal,
                itemBuilder: (BuildContext context, int index) {
                  final int count = Person.leaderboardList.length > 10
                      ? 10
